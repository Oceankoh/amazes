...
You will start at the top left and your goal is to navigate your way down to the bottom right corner marked with the star icon.
Use the arrow buttons below the maze to move.
Be quick on your fingers as there is a timer running immediately after the maze is generated.
Your score will be calculated according to your specified size and time taken to complete the maze.
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
              ...
              child: Text('Help', style: Theme.of(context).textTheme.headline)),
          Padding(
